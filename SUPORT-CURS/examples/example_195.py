           ...
           b = stat(a)
           print(b)
        the average (AV; mathematically denoted as
        denoted as σ), and the coefficient of variation
                      x = i=1 i = i
               n (x − x)2  n−1 (a[i] −
          σ =  i=1 i   =   i=0
                          Cv = =
        (AV) is calculated by dividing the sum b by t
        and the result is stored in r[0]. The code th
        differences from the average (e) for each ele
