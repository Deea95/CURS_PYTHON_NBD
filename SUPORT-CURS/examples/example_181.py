          ...
          This code defines functions for XNOR, XO
        NOR) logical operation, and it also includes s
        the same (either both 0 or both 1), and it re
        The code then prints the result of applying th
        xor(a, b) function calculates the XOR opera
